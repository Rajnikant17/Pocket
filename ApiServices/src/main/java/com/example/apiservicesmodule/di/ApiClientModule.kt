package com.example.apiservicesmodule.di

import com.example.apiservicesmodule.utils.ApiServices
import com.example.apiservicesmodule.utils.Constants
...
object ApiClientModule {
    ...
    fun okHttpClient(httpLoggingInterceptor: HttpLoggingInterceptor): OkHttpClient {
        return OkHttpClient.Builder().addInterceptor(httpLoggingInterceptor)
            .readTimeout(80, TimeUnit.SECONDS).writeTimeout(80, TimeUnit.SECONDS).build()
